...
def detec_propaganda():
    ...
    try:
        found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "fechar.png")
        sleep(33)
...
def pular():
    found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "pular.png")

def voltar():
    found_image((Path.cwd() / "Pyautogui" / "imagens" / "busca" / "voltar.png"))
...
for i in range (2): #2
    #clique no busca 1
    found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "busca1.png")

    #clique no busca 2
    found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "busca2.png")   
    
    if i == 0:
        pa.write(lista4)
        found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "playlists.png")
        found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "drop_the_bass.png")
    ...
    # play
    sleep(3)
    found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "play.png")
    ...
    pa.scroll(-50)
    found_image(Path.cwd() / "Pyautogui" / "imagens" / "busca" / "primeira.png")

    '''
    path = str (Path.cwd() / "Pyautogui" / "imagens" / "busca" / "titulo.png")
